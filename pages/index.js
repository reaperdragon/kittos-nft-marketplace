...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* HeroSection */}
      <section className="max-w-[1240px] my-20 mx-auto grid grid-cols-2  gap-2 font-body h-[540px] overflow-hidden top-7 md:gap-12 medium md:px-5 sm:grid-cols-1 sm:h-full">
      ...
      {/* Community */}
      <section className="max-w-[1240px] bg- my-20 mx-auto bg-[#272D37] gap-2 font-body top-7 text-center p-10 rounded-xl sm:mx-10 md:m-10">
        <div>
